...
#   3.  Enable custom-locations + cluster-connect (runs ON VM via run-command; CLI updates Helm)
#   4.  Enable workload identity webhook (az connectedk8s update from Windows, waits for pods)
#   5.  Grant Key Vault Secrets User to Arc cluster identity (dynamic role assignment)
#   6.  Run `az iot ops init` (Arc extensions + cert-manager)
#   7.  Run `az iot ops create` (deploy AIO instance, includes --ns-resource-id for AIO v1.2+)
#   8.  Enable AIO secret sync (az iot ops secretsync enable with correct --name flag)
#   9.  Grant Key Vault Secrets User to AIO instance identity (dynamic role assignment)
#  10.  Seed placeholder secrets in Key Vault
#  11.  Optional: deploy edge modules
#
...
# ===========================================================================
Write-Step "Step 1/11: Waiting for cloud-init bootstrap (/tmp/k3s-ready)"
...
if (-not $SkipArc) {
    ...
    #   --enable-workload-identity : Registers feature with ARM (webhook deployed in Step 4)
    # =======================================================================
    Write-Step "Step 2/11: Connecting K3s cluster to Azure Arc"
...
"@
    ...
    # =======================================================================
    # STEP 3 — Enable custom-locations + cluster-connect features
    #
    ...
    # =======================================================================
    Write-Step "Step 3/11: Enabling custom-locations + cluster-connect (CLI updates ARM + Helm)"
...
"@
    ...
    # =======================================================================
    # STEP 4 — Enable workload identity webhook
    #
    ...
    # =======================================================================
    Write-Step "Step 4/11: Enabling workload identity webhook (az connectedk8s update)"
    ...
    # =======================================================================
    # STEP 5 — Grant KV Secrets User to Arc cluster identity
    #
    ...
    # =======================================================================
    Write-Step "Step 5/11: Granting KV Secrets User to Arc cluster identity"
...
if (-not $SkipAio) {
    ...
    # =======================================================================
    Write-Step "Step 6/11: Running az iot ops init"
    ...
    # =======================================================================
    Write-Step "Step 7/11: Running az iot ops create"
    ...
    # =======================================================================
    Write-Step "Step 8/11: Enabling AIO secret sync"
    ...
    # =======================================================================
    # STEP 9 — Grant KV Secrets User to AIO instance identity
    #
    ...
    # =======================================================================
    Write-Step "Step 9/11: Granting KV Secrets User to AIO instance identity"
    ...
    # =======================================================================
    # STEP 10 — Seed placeholder secrets in Key Vault
    ...
    # =======================================================================
    Write-Step "Step 10/11: Seeding Key Vault placeholder secrets"
    ...
    # =======================================================================
    # STEP 11 — Optional edge module deployment
    # =======================================================================
    Write-Step "Step 11/11: Edge module deployment"
