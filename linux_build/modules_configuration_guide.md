...
Modules and tools are configured in the `edge_config.json` file:
...
1. **Reads Configuration**: Parses `edge_config.json` modules section
...
cat edge_config.json | jq '.modules'
