...
The `optional_tools` section in `aio_config.json` controls installation of helpful utilities for debugging, managing, and accessing your edge deployment.
...
### Installation
Set `"k9s": true` in aio_config.json and run `linux_installer.sh`
...
### Installation
Set `"mqtt-viewer": true` in aio_config.json and run `linux_installer.sh`
...
### Installation
Set `"mqttui": true` in aio_config.json and run `linux_installer.sh`
...
### Installation
Set `"ssh": true` in aio_config.json and run `linux_installer.sh`
